    ...
    <form action="" method="post">
        ...
        <div class="form-group w-50">
            ...
            <select name="level" id="">
                ...
                <option value="kosi" <?php if($row['level']=="koki") echo "selected" ?> >koki</option>
                <option value="kasir" <?php if($row['level']=="kasir") echo "selected" ?> >kasirS</option>
...
<?php
    ...
    if (isset($_POST['simpan'])) {
       ...
       if ($password === $konfirmasi) {
            $sql = "UPDATE tbluser SET user='$user', emai='$email', password='$password', level='$level' WHERE iduser=$id";
